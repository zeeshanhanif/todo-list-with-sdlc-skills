...
| FR-DATA-001 | Export all data as JSON | Must | Active | PRIV | UC-015 | features/FEAT-017-export-data/technical-design.md; features/FEAT-017-export-data/ui-design.md | FEAT-017 | _TBD_ |
| FR-DATA-002 | Export includes lists + active/completed tasks | Must | Active | PRIV | UC-015 | features/FEAT-017-export-data/technical-design.md; features/FEAT-017-export-data/ui-design.md | FEAT-017 | _TBD_ |
