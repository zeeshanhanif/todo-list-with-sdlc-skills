...
| FR-AUTH-006 | Mark account verified on valid link | Must | Active | SI | UC-002 | features/FEAT-002-verify-email/technical-design.md; features/FEAT-002-verify-email/ui-design.md | FEAT-002 | _TBD_ |
| FR-AUTH-007 | Require verification before sign-in | Must | Active | SI | UC-002, UC-003 | features/FEAT-002-verify-email/technical-design.md; features/FEAT-002-verify-email/ui-design.md | FEAT-002, FEAT-003 | _TBD_ |
| FR-AUTH-008 | Resend verification email | Should | Active | SI | UC-002 | ADR-007; features/FEAT-002-verify-email/technical-design.md; features/FEAT-002-verify-email/ui-design.md | FEAT-002 | _TBD_ |
