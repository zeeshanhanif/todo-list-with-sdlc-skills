...
| :----- | :------------------ | :------- | :----- | :----- | :---------- | :--------- | :------- | :------- |
| FR-AUTH-001 | Register with email + password | Must | Active | SI | UC-001 | _TBD_ | FEAT-001 | _TBD_ |
| FR-AUTH-002 | Reject duplicate email at registration | Must | Active | SI | UC-001 | _TBD_ | FEAT-001 | _TBD_ |
| FR-AUTH-003 | Validate email format | Must | Active | SI | UC-001 | _TBD_ | FEAT-001 | _TBD_ |
| FR-AUTH-004 | Enforce password policy | Must | Active | SEC | UC-001 | arch §8 | FEAT-001 | _TBD_ |
| FR-AUTH-005 | Send verification email (single-use, time-limited) | Must | Active | SI | UC-001, UC-002 | ADR-007 | FEAT-001, FEAT-007 | _TBD_ |
...
| FR-AUTH-013 | Send single-use reset link | Must | Active | SI | UC-005 | ADR-007 | FEAT-005, FEAT-007 | _TBD_ |
...
| FR-LIST-003 | Auto-create default Inbox on registration | Must | Active | SI | UC-001 | ADR-003 | FEAT-001 | _TBD_ |
