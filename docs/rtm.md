...
| FR-PROF-001 | View profile (email, display name) | Must | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | _TBD_ |
| FR-PROF-002 | Set/edit display name | Should | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | _TBD_ |
| FR-PROF-003 | Set timezone (due/overdue calc) | Must | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | _TBD_ |
| FR-PROF-004 | Select UI theme, persisted | Should | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | _TBD_ |
| FR-PROF-005 | Persist settings across devices | Must | Active | SI | UC-007 | ADR-003; features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | _TBD_ |
...
| NFR-LOC-001 | Store UTC, display user timezone | Must | Active | SI | UC-007 | arch §8; features/FEAT-008-profile/technical-design.md | Foundations, FEAT-008 | features/FEAT-010-create-task/acceptance-report.md (partial) |
