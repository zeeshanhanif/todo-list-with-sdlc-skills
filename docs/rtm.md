...
| FR-AUTH-012 | Forgot-password request (neutral response) | Must | Active | SI | UC-005 | arch §8; features/FEAT-005-reset-password/technical-design.md; features/FEAT-005-reset-password/ui-design.md | FEAT-005 | features/FEAT-005-reset-password/acceptance-report.md |
| FR-AUTH-013 | Send single-use reset link | Must | Active | SI | UC-005 | ADR-007; features/FEAT-007-email-delivery/technical-design.md; features/FEAT-005-reset-password/technical-design.md | FEAT-005, FEAT-007 | features/FEAT-007-email-delivery/acceptance-report.md (partial); features/FEAT-005-reset-password/acceptance-report.md (partial) |
| FR-AUTH-014 | Set new password via reset link | Must | Active | SI | UC-005 | ADR-005; features/FEAT-005-reset-password/technical-design.md; features/FEAT-005-reset-password/ui-design.md | FEAT-005 | features/FEAT-005-reset-password/acceptance-report.md |
| FR-AUTH-015 | Change password (verify current) | Must | Active | SI | UC-006 | ADR-005; features/FEAT-006-change-password/technical-design.md; features/FEAT-006-change-password/ui-design.md | FEAT-006 | features/FEAT-006-change-password/acceptance-report.md |
...
| FR-PROF-001 | View profile (email, display name) | Must | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | features/FEAT-008-profile/acceptance-report.md |
| FR-PROF-002 | Set/edit display name | Should | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | features/FEAT-008-profile/acceptance-report.md |
| FR-PROF-003 | Set timezone (due/overdue calc) | Must | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | features/FEAT-008-profile/acceptance-report.md |
| FR-PROF-004 | Select UI theme, persisted | Should | Active | SI | UC-007 | features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | features/FEAT-008-profile/acceptance-report.md |
| FR-PROF-005 | Persist settings across devices | Must | Active | SI | UC-007 | ADR-003; features/FEAT-008-profile/technical-design.md; features/FEAT-008-profile/ui-design.md | FEAT-008 | features/FEAT-008-profile/acceptance-report.md |
| FR-LIST-001 | Create list with name | Must | Active | SI | UC-008 | ADR-003; features/FEAT-009-lists/technical-design.md; features/FEAT-009-lists/ui-design.md | FEAT-009 | features/FEAT-009-lists/acceptance-report.md |
| FR-LIST-002 | Validate list name | Must | Active | SI | UC-008 | features/FEAT-009-lists/technical-design.md; features/FEAT-009-lists/ui-design.md | FEAT-009 | features/FEAT-009-lists/acceptance-report.md |
...
| FR-LIST-004 | Prevent deletion of Inbox (allow rename) | Must | Active | SI | UC-008 | ADR-003; features/FEAT-009-lists/technical-design.md; features/FEAT-009-lists/ui-design.md | FEAT-009 | features/FEAT-009-lists/acceptance-report.md |
| FR-LIST-005 | View lists with active-task counts | Must | Active | SI | UC-008 | ADR-003; features/FEAT-009-lists/technical-design.md; features/FEAT-009-lists/ui-design.md | FEAT-009 | features/FEAT-009-lists/acceptance-report.md |
...
| FR-SRCH-004 | Filter by due date | Must | Active | SI | UC-013 | features/FEAT-015-search/technical-design.md; features/FEAT-015-search/ui-design.md | FEAT-015 | features/FEAT-015-search/acceptance-report.md |
| FR-SRCH-005 | Combine search + filters (conjunctive) | Should | Active | SI | UC-013 | features/FEAT-015-search/technical-design.md; features/FEAT-015-search/ui-design.md | FEAT-015 | features/FEAT-015-search/acceptance-report.md |
| FR-SRCH-006 | Empty-state message | Must | Active | SI | UC-013, UC-014 | features/FEAT-015-search/technical-design.md; features/FEAT-015-search/ui-design.md; features/FEAT-016-smart-views/technical-design.md; features/FEAT-016-smart-views/ui-design.md | FEAT-015, FEAT-016 | features/FEAT-015-search/acceptance-report.md (partial) |
| FR-SRCH-007 | Smart views (Today/Upcoming/Overdue/All) | Should | Active | SI | UC-014 | features/FEAT-016-smart-views/technical-design.md; features/FEAT-016-smart-views/ui-design.md | FEAT-016 | _TBD_ |
| FR-SRCH-008 | Smart-view membership semantics | Should | Active | SI | UC-014 | features/FEAT-016-smart-views/technical-design.md; features/FEAT-016-smart-views/ui-design.md | FEAT-016 | _TBD_ |
| FR-SRCH-009 | Paginate/lazy-load large views | Should | Active | SI | UC-013 | arch §8; features/FEAT-015-search/technical-design.md; features/FEAT-015-search/ui-design.md; features/FEAT-016-smart-views/technical-design.md; features/FEAT-016-smart-views/ui-design.md | FEAT-015 | features/FEAT-015-search/acceptance-report.md |
...
| NFR-SEC-003 | Password policy (≥10, breach-checked) | Must | Active | SEC | UC-001, UC-005, UC-006 | arch §8 | Foundations | features/FEAT-005-reset-password/acceptance-report.md (partial — reset path); features/FEAT-006-change-password/acceptance-report.md (partial — change path) |
| NFR-SEC-004 | Link expiry (verify 24h, reset 1h) | Must | Active | SEC | UC-002, UC-005 | arch §8; features/FEAT-005-reset-password/technical-design.md | FEAT-002, FEAT-005 | features/FEAT-005-reset-password/acceptance-report.md (partial — reset 1h) |
| NFR-SEC-005 | Salted adaptive password hashing | Must | Active | SEC | — | arch §8 | Foundations | features/FEAT-006-change-password/acceptance-report.md (partial — change path) |
| NFR-SEC-006 | Rate limiting thresholds | Must | Active | SEC | UC-003 | arch §8; features/FEAT-003-sign-in/technical-design.md | FEAT-003 | features/FEAT-003-sign-in/acceptance-report.md (partial); features/FEAT-005-reset-password/acceptance-report.md (partial); features/FEAT-006-change-password/acceptance-report.md (partial — change endpoint) |
| NFR-SEC-007 | Secure session tokens, CSRF, rotation | Must | Active | SEC | — | ADR-005; features/FEAT-003-sign-in/technical-design.md (partial — session cookie) | Foundations | features/FEAT-003-sign-in/acceptance-report.md (partial); features/FEAT-006-change-password/acceptance-report.md (partial — rotation on password change) |
...
| NFR-LOC-001 | Store UTC, display user timezone | Must | Active | SI | UC-007 | arch §8; features/FEAT-008-profile/technical-design.md | Foundations, FEAT-008 | features/FEAT-010-create-task/acceptance-report.md (partial); features/FEAT-008-profile/acceptance-report.md (partial) |
