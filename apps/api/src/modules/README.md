...
without owning any of them — the export is a cross-entity read by nature. That
is not a boundary violation (the rule forbids importing another module's
*code*, which it does not do); see FEAT-017 technical-design §2.
...
| `account-data` | FR-DATA-* | FEAT-017 ✅ built (export); FEAT-018 (delete account) |
