...
// a successful registration. The Resend control binds to POST /auth/verify/resend
// (FEAT-002, FR-AUTH-008); its resend-sent + client-side cooldown states live in
// the shared ResendVerification component.
function Notice() {
    ...
    <AuthShell>
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ marginTop: "var(--space-5)" }}>
          <ResendVerification email={emailParam ?? undefined} />
        </div>
        <p style={{ marginTop: "var(--space-4)", fontSize: "var(--font-size-small)" }}>
