...
// a request flows end-to-end (web shell -> API /healthz -> Postgres write+read
// -> back) in a running local environment, and the token-styled shell renders
// the result. Later work extends this suite with the architecture's critical
// flows (auth, task CRUD).
